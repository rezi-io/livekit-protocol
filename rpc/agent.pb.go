...
var file_rpc_agent_proto_rawDesc = []byte{
	...
	0x65, 0x28, 0x01, 0x42, 0x29, 0x5a, 0x27, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
	0x6d, 0x2f, 0x72, 0x65, 0x7a, 0x69, 0x2d, 0x69, 0x6f, 0x2f, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69,
	0x74, 0x2d, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x2f, 0x72, 0x70, 0x63, 0x62, 0x06,
...
func file_rpc_agent_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_rpc_agent_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*JobRequestResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_rpc_agent_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_rpc_agent_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
