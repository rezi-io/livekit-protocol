...
const file_livekit_room_proto_rawDesc = "" +
	...
	"\bmetadata\x18\x05 \x01(\tB&\x88\xb5\x18\x01\x92\xb5\x18\x1e<redacted ({{ .Size }} bytes)>R\bmetadata\x12+\n" +
	...
	"\bmetadata\x18\x03 \x01(\tB&\x88\xb5\x18\x01\x92\xb5\x18\x1e<redacted ({{ .Size }} bytes)>R\bmetadata\x12>\n" +
	"\n" +
	"permission\x18\x04 \x01(\v2\x1e.livekit.ParticipantPermissionR\n" +
	"permission\x12:\n" +
	"\x04name\x18\x05 \x01(\tB&\x88\xb5\x18\x01\x92\xb5\x18\x1e<redacted ({{ .Size }} bytes)>R\x04name\x12y\n" +
	"\n" +
	"attributes\x18\x06 \x03(\v21.livekit.UpdateParticipantRequest.AttributesEntryB&\x88\xb5\x18\x01\x92\xb5\x18\x1e<redacted ({{ .Size }} bytes)>R\n" +
	"attributes\x1a=\n" +
	...
	"\bmetadata\x18\x02 \x01(\tB&\x88\xb5\x18\x01\x92\xb5\x18\x1e<redacted ({{ .Size }} bytes)>R\bmetadata\"\xc4\x03\n" +
	...
	"\bmetadata\x18\v \x01(\tB&\x88\xb5\x18\x01\x92\xb5\x18\x1e<redacted ({{ .Size }} bytes)>R\bmetadata\x12+\n" +
	...
	"\n" +
	"PerformRpc\x12\x1a.livekit.PerformRpcRequest\x1a\x1b.livekit.PerformRpcResponseBFZ#github.com/rezi-io/livekit-protocol/livekit\xaa\x02\rLiveKit.Proto\xea\x02\x0eLiveKit::Protob\x06proto3"
