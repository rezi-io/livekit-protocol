...
var file_livekit_agent_dispatch_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x4e, 0x5a, 0x2b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
	0x63, 0x6f, 0x6d, 0x2f, 0x72, 0x65, 0x7a, 0x69, 0x2d, 0x69, 0x6f, 0x2f, 0x6c, 0x69, 0x76, 0x65,
	0x6b, 0x69, 0x74, 0x2d, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x2f, 0x6c, 0x69, 0x76,
...
var file_livekit_agent_dispatch_proto_goTypes = []interface{}{
...
func file_livekit_agent_dispatch_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_livekit_agent_dispatch_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_livekit_agent_dispatch_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_livekit_agent_dispatch_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_livekit_agent_dispatch_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_livekit_agent_dispatch_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_livekit_agent_dispatch_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_livekit_agent_dispatch_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
